...
const Header = () => {
    ...
    return (
        <>
            <div className={`navbar rounded-md ${isDarkMode ? 'bg-slate-500' : 'bg-green-300'}`}>
                <div className="navbar-start">
                    <div className="dropdown">
                        <label tabIndex={0} className="btn btn-ghost lg:hidden">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
                        </label>
                        <ul tabIndex={0} className={`menu menu-sm dropdown-content mt-3 p-2 shadow ${isDarkMode ? 'bg-slate-500 text-white' : 'bg-green-200'} z-10 rounded-box w-52`}>
                            {menuItems}
                            <li className='md:hidden my-4 border border-red-200'>
                ...
                <div className="navbar-end md:flex items-center">
